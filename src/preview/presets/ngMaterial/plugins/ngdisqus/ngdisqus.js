(function () {
    ...
    m.provider('$disqus', function() {
        ...
        this.$get = [ '$location', function($location) {
             ...
             * @param  {String} sn shortname
             */
            function commit(id, sn) {
                var shortname = sn||getShortname();
     ...
     */
    m.directive('disqus', [ '$disqus', function($disqus) {
            ...
            link: function link(scope) {
                scope.$watch('id', function(id) {
                    if (angular.isDefined(id)) {
                        $disqus.commit(id, scope.shortname);
                    }
                });
            }
        };
     ...
     */
    m.directive('disqusIdentifier', [ '$disqus', function($disqus) {
        return {
            restrict : 'A',
