...
(function (angular, undefined) {
    "use strict";
    angular.module('quartz.components').service("$previousState", ['$rootScope', '$state', '$q', function ($rootScope, $state, $q) {
    ...
    angular.module('quartz.components').run(['$previousState', function ($previousState) {
