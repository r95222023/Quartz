(function() {
    ...
    /* @ngInject */
    function CalendarController($scope, $rootScope, $mdDialog, $mdToast, $filter, $element, qtTheming, qtLayout, uiCalendarConfig) {
        var vm = this;
        ...
        vm.calendarOptions = {
            ...
            viewRender: function(view) {
                ...
                qtLayout.layout.contentClass = 'calendar-background-image background-overlay-static overlay-gradient-10 calendar-background-month-' + vm.currentDay.month();
            },
            ...
            eventClick: function(calEvent, jsEvent, view) { //eslint-disable-line
                ...
                .then(function(event) {
                    ...
                    if(angular.isDefined(event.deleteMe) && event.deleteMe === true) {
                        ...
                        uiCalendarConfig.calendars['quartz-calendar'].fullCalendar('removeEvents', event._id);
                        // change toast message
                        toastMessage = 'CALENDAR.EVENT.EVENT-DELETED';
                    }
                    else {
                        // update event
                        uiCalendarConfig.calendars['quartz-calendar'].fullCalendar('updateEvent', event);
                    }
        ...
        function createRandomEvents(number, startDate, endDate) {
            ...
            for(var x = 0; x < number; x++) {
                ...
                var randomPalette = pickRandomProperty(qtTheming.palettes);
                ...
                vm.eventSources[0].events.push({
                    ...
                    backgroundColor: qtTheming.rgba(qtTheming.palettes[randomPalette]['500'].value),
                    borderColor: qtTheming.rgba(qtTheming.palettes[randomPalette]['500'].value),
                    textColor: qtTheming.rgba(qtTheming.palettes[randomPalette]['500'].contrast),
