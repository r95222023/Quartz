...
gulp.task('lazyload', function () {
    return gulp.src(paths.src + '/app/lazyload/**/*')
        .pipe(gulp.dest(paths.dist + '/app/lazyload'));
});
...
gulp.task('buildapp', ['html','preview', 'images','lazyload', 'core', 'fonts', 'translations', 'misc', 'data', 'examplejs']);
