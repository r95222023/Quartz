(function() {
    ...
    function moduleConfig($translatePartialLoaderProvider, $stateProvider, qtMenuProvider) {
        ...
        .state('quartz.admin-default.layouts-example-tall-toolbar', {
            data: {
                layout: {
                    toolbarSize: 'md-tall',
        ...
        .state('quartz.admin-default.layouts-example-icon-menu', {
            data: {
                layout: {
                    sideMenuSize: 'icon'
                }
