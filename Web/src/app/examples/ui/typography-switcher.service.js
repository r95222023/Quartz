(function() {
    ...
    function TypographySwitcher($window, $cookies, $log, UI_FONTS) {
        ...
        function getCurrentFont() {
            ...
            var fontCookie = $cookies.get('qt-typography-font');
            if(angular.isUndefined(fontCookie)) {
                $cookies.put('qt-typography-font', angular.toJson(UI_FONTS[0]));
            }

            return angular.fromJson($cookies.get('qt-typography-font'));
        }
        ...
        function changeFont(font) {
            $window.WebFont.load({
                ...
                active: function() {
                    ...
                    $cookies.put('qt-typography-font', angular.toJson(font));
                },
                inactive: function() {
