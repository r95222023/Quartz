(function() {
    ...
    /* @ngInject */
    function EventDialogController($scope, $mdDialog, $filter, qtTheming, dialogData, event, edit) {
        ...
        // create colors
        angular.forEach(qtTheming.palettes, function(palette, index) {
            var color = {
                name: index.replace(/-/g, ' '),
                palette: index,
                backgroundColor: qtTheming.rgba(palette['500'].value),
                textColor: qtTheming.rgba(palette['500'].contrast)
            };
