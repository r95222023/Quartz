(function() {
    ...
    /* @ngInject */
    function LayoutsComposerController($rootScope, $filter, $document, qtTheming, qtLayout) {
        var vm = this;
        vm.allPagesCode = '';
        ...
        function createCodeSnippets() {
            vm.allPagesCode =
                'qtLayoutProvider.setDefaultOption(\'toolbarSize\', \'' + vm.layout.toolbarSize + '\');\n' +
                'qtLayoutProvider.setDefaultOption(\'toolbarShrink\', ' + vm.layout.toolbarShrink + ');\n' +
                'qtLayoutProvider.setDefaultOption(\'toolbarClass\', \'' + vm.layout.toolbarClass + '\');\n' +
                'qtLayoutProvider.setDefaultOption(\'contentClass\', \'' + vm.layout.contentClass + '\');\n' +
                'qtLayoutProvider.setDefaultOption(\'sideMenuSize\', \'' + vm.layout.sideMenuSize + '\');\n' +
                'qtLayoutProvider.setDefaultOption(\'footer\', ' + vm.layout.footer + ');\n';

            vm.onePageCode =
                '.state(\'quartz.admin-default.my-state\', {' + '\n' +
