(function() {
    ...
    /* @ngInject */
    function CalendarToolbarController($scope, $state, $element, $mdUtil, $mdSidenav, qtBreadcrumbsService, uiCalendarConfig) {
        var vm = this;
        ...
        function changeMonth(direction) {
            uiCalendarConfig.calendars['quartz-calendar'].fullCalendar(direction);
        }

        function changeView(view) {
            vm.currentView = view;
            uiCalendarConfig.calendars['quartz-calendar'].fullCalendar('changeView', view.viewName);
        }
